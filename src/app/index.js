...
import { Header, ContentPlacement, TypographicIntro, Footer, Hyperlink, Radio } from '@ms-fw/fw-react/components';
...
const styles = require('../../fwbuild/public/assets/styles/css/fw-west-european-default-orange.css');
...
ReactDOM.render(
    <Radio
        name="Shipping or pick up radio item selection"
        label={data.label}
        items={data.items}
    />
//    <div>
